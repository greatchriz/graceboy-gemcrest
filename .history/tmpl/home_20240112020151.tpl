...
$features = [
  [
    "iconSrc" => "assets/images/feature/1.png",
    "title" => "Reliability",
    "content" => "Maecenas tempuslusning eget condim entum and rhoncus eumpesit."
  ],
  [
    "iconSrc" => "assets/images/feature/2.png",
    "title" => "Reliability",
    "content" => "Maecenas tempuslusning eget condim entum and rhoncus eumpesit."
  ],
  [
    "iconSrc" => "assets/images/feature/3.png",
    "title" => "Reliability",
    "content" => "Maecenas tempuslusning eget condim entum and rhoncus eumpesit."
  ],
  [
    "iconSrc" => "assets/images/feature/4.png",
    "title" => "Reliability",
    "content" => "Maecenas tempuslusning eget condim entum and rhoncus eumpesit."
  ]
];
    ...
    <div class="brand__slider">
      <div class="single-slide">
        <div class="brand__item">
          <img
            src="assets/images/brand/item1.png"
            alt="brand"
          />
        </div>
      </div>
