...
{include file="pages_banner.tpl" title="Contact Us" title2="Contact" innerBannerThumbBg="assets/images/banner/inner-thumb.png"}
      ...
      <div class="col-lg-4 col-md-6 col-sm-10">
        <div class="contact__info__item plan__item">
          ...
          <div class="content">
            ...
            <ul class="contacts">
              <li>
                <a href="https://template.viserlab.com/cdn-cgi/l/email-protection#7e1a1b13113e19131f1712501d1113"><span
                    class="__cf_email__"
                    data-cfemail="cda5a8a1a1a2e3aeb4afa8bf8daaa0aca4a1e3aea2a0"
                  >support@gemcrest.org</span></a>
              </li>
              <li>
                <a href="https://template.viserlab.com/cdn-cgi/l/email-protection#3f5b5a52507f58525e5653115c5052"><span
                    class="__cf_email__"
                    data-cfemail="e78f828b8b88c9849e858295a7808a868e8bc984888a"
                  >support@gemcrest.org</span></a>
              </li>
            </ul>
          </div>
    ...
    <div class="container padding-top padding-bottom contact__area">
      <div class="contact__form__wrapper mx-auto me-lg-0">
        ...
        <form
          ...
          action="https://template.viserlab.com/digihyip/demo/contact.php"
        >
