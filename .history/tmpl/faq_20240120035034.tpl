...
<section class="faq-section padding-top padding-bottom">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="section__header text-center max-p">
                    <h2 class="section__header-title">Frequently Asked Questions 01</h2>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        ...
                        <div class="faq__wrapper">
                            ...
                            {include 
          file="components/faq-detail.tpl" 
          ...
          title="How do I create my Gem Crest Account?" 
          ...
          content="Gem Crest accepts Bitcoin, USDT-Erc20, USDT-Trc20 & TRX as the means of making deposits."
      }
          ...
          title="How long does it take for my deposit to be added to my Gem Crest account?" 
          ...
          content="Log into your Gem Crest account and click on the 'Edit Account Section'. You can change your e-mail address and password there."
      }
          ...
          content="No, profits are gathered on your Gem Crest account and you can withdraw them anytime to your attached wallet."
      }
      ...
      content="Depending on each plan. Interest on your Gem Crest account is acquired Daily and credited to your available balance at the end of each day."
      }
      ...
      content="Yes! To make a deposit from your Gem Crest account balance. Simply login into your members account and click on Make Deposit and select the Deposit from Account Balance Radio button."
      }
      ...
      title="Can I make an additional deposit to Gem Crest account once it has been opened?" 
      ...
      content="You can close your East Fortune Investment account anytime you wish. You can easily re-open them if you want to in the future. To close your account, please write to us on support@zenithearners.org or Speak with an Agent through the customer live support, We strongly recommend you to withdraw all your funds before closing your account. By doing so, your investments will be secured and you'll be ready to leave."
                  ...
                  content="There are no fees or penalties for closing/deleting your Gem Crest account."
              }
                  ...
                  title="What is Gem Crest referral program?" 
                  ...
                  title="How does the Gem Crest referral program work?" 
                  content="To share your love of Gem Crest, give your personal referral link to friends and family and encourage them to visit our website. Once they register with your referral link and invest, you will get 10% commission from their Gem Crest deposit."
              }
                  ...
                  title="How much does the Gem Crest referral program offer?" 
                  ...
                  content="If you can't find the answer to your question, please write to us with the help of the 'CONTACT US' form or email us at support@Gem Crest.org"
              }
