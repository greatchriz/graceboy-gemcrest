...
features= [
    [
        ...
        "title" => "Reliability",
        "content" => "Maecenas tempuslusning eget condim entum and rhoncus eumpesit."
      ],
      [
...
<!-- Blog Section Ends Here -->
  ...
  https://images.mudrex.com/homepage-web/cxotoday.svg
  https://images.mudrex.com/homepage-web/deccanHerald.svg
  https://images.mudrex.com/homepage-web/cnbc.svg
  https://images.mudrex.com/homepage-web/republicWorld.svg
  https://images.mudrex.com/homepage-web/analyticsInside.svg
  https://images.mudrex.com/homepage-web/inc42.svg
  https://images.mudrex.com/homepage-web/outlook.svg
  https://images.mudrex.com/homepage-web/mint.svg
  https://images.mudrex.com/homepage-web/moneycontrol.svg
  https://images.mudrex.com/homepage-web/yourstory.svg
  https://images.mudrex.com/homepage-web/productHunt.svg
  https://images.mudrex.com/homepage-web/ndtv.svg
  https://images.mudrex.com/homepage-web/bitcoinInsider.svg

  using this src links above generate this code below
  <div class="single-slide">
  ...
  for each of them and then use the src link as the img src attribute value
