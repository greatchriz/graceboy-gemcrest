  ...
  <html lang="en">
    ...
    <body>
              ...
              <ul class="contacts d-flex flex-wrap justify-content-center">
                <li>
                  <a
                    ...
                    <span
                      class="__cf_email__"
                      data-cfemail="f195949c9eb1969c90989ddf929e9c"
            ...
            <div class="header-bottom-area">
              ...
              <ul class="menu">
                <li>
                  <a href="#0">Home</a>
                  <ul class="sub-menu">
                    <li><a href="/?a=home">Home One</a></li>
      ...
      <div class="inner-banner section-bg overflow-hidden">
        ...
        <div class="shapes">
          <img
            src="assets/images/banner/inner-bg.png"
            alt="banner"
            class="shape shape1" />
          <img
            src="assets/images/banner/inner-thumb.png"
            alt="banner"
