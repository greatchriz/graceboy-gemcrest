          ...
          <div class="row align-items-center">
            <div class="col-lg-6 d-none d-lg-block">
              <div class="section__thumb profit__calculation__thumb rtl me-5">
                <img alt="" loading="lazy" width="760" height="450" decoding="async" data-nimg="1" src="https://images.mudrex.com/vault/coin-tv.svg" style="color: transparent;">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="profit__calculation__content">
                <div class="section__header">
                  ...
                  <p>
                    Get an instant profit on your investment.
                  </p>
                </div>
